...
void action_new_folder(linked_list* items, list_item* selected) {
    ...
    if(data == NULL) {
        error_display(NULL, NULL, "新しいフォルダデータの割り当てに失敗しました。");
    ...
    kbd_display("フォルダ名を入力してください", "", SWKBD_TYPE_NORMAL, 0, SWKBD_NOTEMPTY_NOTBLANK, FILE_NAME_MAX, data, action_new_folder_onresponse);
}